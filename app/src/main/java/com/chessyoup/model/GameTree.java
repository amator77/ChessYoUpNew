...
public class GameTree {
    ...
    public final void setPlayerNames(String white, String black) {
        this.white = white;
        this.black = black;
        updateListener();
    }
    ...
    public static class Node {
        ...
        public String preComment;          // Comment before move
        public String postComment;         // Comment after move
        ...
        public final static int strToNag(String str) {
            ...
            else if (str.equals("â�ž")) return 13;
